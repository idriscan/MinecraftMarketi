...
function setupContactPage() {
    const complaintSelect = document.getElementById('complaint-type');
    ...
    if (complaintSelect && otherFields) {
        complaintSelect.addEventListener('change', function () {
            if (this.value === 'other') {
                otherFields.classList.remove('hidden');
                document.getElementById('other-subject').required = true;
                document.getElementById('other-message').required = true;
            } else {
                otherFields.classList.add('hidden');
                document.getElementById('other-subject').required = false;
                document.getElementById('other-message').required = false;
            }
        });
    }
